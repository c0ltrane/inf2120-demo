...
public class Pdemo extends JFrame {
	...
	public Pdemo() {
		...
		// WEST
		JPanel panneauWest = new JPanel( new GridLayout( 3, 1 ) );

		// Exo n2
		panneauWest.add( new JLabel( "Description Onde 1 :" ) );
		...
		panneauWest.add( list1, BorderLayout.WEST );

		// Exo n3
		JSlider slider1 = new JSlider( 0, 100, 50 );
		slider1.addChangeListener( (e) -> ondeRatio[0] = slider1.getValue() / 100.0 );
		panneauWest.add( slider1 );

		add(panneauWest, BorderLayout.WEST );

		// EAST
		JPanel panneauEast = new JPanel( new GridLayout( 3, 1 ) );

		// Exo n2
		panneauEast.add( new JLabel( "Description Onde 2 :" ) );
		...
		panneauEast.add( list2 );

		// Exo n3
		JSlider slider2 = new JSlider( 0, 100, 50 );
		slider2.addChangeListener( (e) -> ondeRatio[1] = slider2.getValue() / 100.0 );
		panneauEast.add( slider2 );

		add(panneauEast, BorderLayout.EAST);
		...
		sliderVolume.addChangeListener( (e) -> ratioVolume = sliderVolume.getValue() / 100.0 );
		panneauSouth.add( sliderVolume, cSliderRatioVolume );
	...
	public static void main(String[] args) {
		javax.swing.SwingUtilities.invokeLater( () -> new Pdemo() );
	}
}
